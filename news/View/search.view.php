...
<section id="browse-news">
	<div class="latest-post-wrap">
		<div class="cat-title"><h2>Từ khóa: Covid</h2></div>
		<div class="row single-latest-post align-items-center">
			<div class="col-lg-5 col-md-5 col-sm-12 post-left">
				<div class="feature-img relative">
					<div class="overlay overlay-bg"></div>
					<img class="img-fluid" src="assets/css/images/DS.jpg" alt="">
				</div>
			</div>
			<div class="col-lg-7 col-md-7 col-sm-12 post-right">
				<a href="#">
					<h4>Cô gái Việt tại Singapore sống tích cực thời dịch</h4>
				</a>
				...
				<p class="description">Irene Le cố gắng duy trì lịch sinh hoạt bình thường để đảm bảo một ngày hiệu quả nhất, hạn chế ra ngoài và tin tưởng vào Chính phủ Singapore.</p>
			</div>
		</div>
